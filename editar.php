...
?>
<?php  echo form_open_multipart('produtos/editar/'.$produto['codigo'], array('id' => 'form_produto') ) ?>
    <div class="row">
        <div class="col-6">
        ...
        <div class="col-3">
            <div class="form-group">
                ...
                <div class="rating">
                    <input name="stars" id="e5" type="radio" value="5" <?php echo ($produto['reputacao'] == "5")? "checked='checked'" : "" ;  ?>></a><label for="e5">★</label>
                    <input name="stars" id="e4" type="radio" value="4" <?php echo ($produto['reputacao'] == "4")? "checked='checked'" : "" ;  ?>></a><label for="e4">★</label>
                    <input name="stars" id="e3" type="radio" value="3" <?php echo ($produto['reputacao'] == "3")? "checked='checked'" : "" ;  ?>></a><label for="e3">★</label>
                    <input name="stars" id="e2" type="radio" value="2" <?php echo ($produto['reputacao'] == "2")? "checked='checked'" : "" ;  ?>></a><label for="e2">★</label>
                    <input name="stars" id="e1" type="radio" value="1" <?php echo ($produto['reputacao'] == "1")? "checked='checked'" : "" ;  ?>></a><label for="e1">★</label>
                </div>
            </div>
        </div>
        <div class="col-3">
            ...
            <div class="col-8">
                 <div class="form-group">
                    <input type="checkbox" id="destaque_home" name="destaque_home" value="1" <?php echo ($produto['destaque_home'] == "1")? "checked='checked'" : "" ;  ?> class="myCheckbox" />
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-group">
                <div class="lista-categorias" style="display: <?= (count($produto['categorias']) > 0) ? 'block' : '' ?>;">
                    ...
                    <?php if(count($produto['categorias']) > 0) : foreach($produto['categorias'] as $categoria) : ?>
                        <div class="lista-categorias__categoria">
                            <input class="form-control" type="text" value="<?php echo $categoria['nome']; ?>" readonly>
                            <input name="categoria[]" type="hidden" value="<?php echo $categoria['codigo']; ?>">
                            <a href="#">
                                <img src="<?php echo site_url(); ?>/assets/images/ico-deletar.png">
                            </a>
                        </div>
        ...
        <div class="col-6">
            ...
            <div class="col-4">
                <div class="form-group">
                    <input type="checkbox" id="empresa_pequena" name="empresas[]"  value="1" <?php echo ($produto['empresas_pequena'] == "1")? "checked='checked'" : "" ;  ?> class="myCheckbox" />
                    <label for="empresa_pequena"><span></span>Pequenas</label>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
                    <input type="checkbox" id="empresa_media" name="empresas[]"  value="2" <?php echo ($produto['empresas_media'] == "1")? "checked='checked'" : "" ;  ?> class="myCheckbox" />
                    <label for="empresa_media"><span></span>Média</label>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
                    <input type="checkbox" id="empresa_grandes" name="empresas[]"  value="3" <?php echo ($produto['empresas_grande'] == "1")? "checked='checked'" : "" ;  ?> class="myCheckbox" />
            ...
            <div class="form-group">
                <div id="conteudo-container">
                    ...
                    <div id="1" style="display:none;" class="box-destaque">
                         <h1>1 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" type="text" value="<?php echo $produto['titulo_1']; ?>" name="titulo-destaque-1">
                         ...
                         <textarea class="form-control" name="conteudo-destaque-1" rows='7'><?php echo $produto['conteudo_1']; ?></textarea>

                        <row class="col-12">
                             
                            <label class="col-12" style="margin-top: 31px;">Tópicos</label>
                                    
                                <textarea class="form-control" id="topicos" name="topico-1"> <?php echo $produto['topico_1'];?> </textarea>
                         </row>
                    ...
                    <div id="2" style="display:none;" class="box-destaque">
                         <h1>2 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" type="text" value="<?php echo $produto['titulo_2']; ?>" name="titulo-destaque-2">
                         ...
                         <label class="col-12">Conteúdo</label>
                         <textarea class="form-control" name="conteudo-destaque-2" rows='7'><?php echo $produto['conteudo_2']; ?></textarea>
                        ...
                        <row class="col-12">
                            ...
                            <textarea class="form-control" id="topicos-2" name="topico-2"> <?php echo $produto['topico_2']; ?> </textarea>
                    ...
                    <div id="3" style="display:none;" class="box-destaque">
                         <h1>3 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" type="text" value="<?php echo $produto['titulo_3']; ?>" name="titulo-destaque-3">
                         ...
                         <label class="col-12">Conteúdo</label>
                         <textarea class="form-control" name="conteudo-destaque-3" rows='7'><?php echo $produto['conteudo_3']; ?></textarea>

                         <row class="col-12">
                             
                            <label class="col-12" style="margin-top: 31px;">Tópicos</label>

                            <textarea class="form-control" id="topicos-3" name="topico-3"> <?php echo $produto['topico_3']; ?> </textarea>
                    ...
                    <div id="4" style="display:none;" class="box-destaque">
                         <h1>4 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" type="text" value="<?php echo $produto['titulo_4']; ?>" name="titulo-destaque-4">
                         ...
                         <label class="col-12">Conteúdo</label>
                         <textarea class="form-control" name="conteudo-destaque-4" rows='7'><?php echo $produto['conteudo_4']; ?></textarea>

                         <row class="col-12">
                             
                            <label class="col-12" style="margin-top: 31px;">Tópicos</label>
                             <textarea class="form-control" id="topicos-4" name="topico-4"> <?php echo $produto['topico_4']; ?> </textarea>
                         </row>
                    ...
                    <div id="5" style="display:none;" class="box-destaque">
                         <h1>5 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" type="text" value="<?php echo $produto['titulo_5']; ?>" name="titulo-destaque-5">
                        ...
                        <div class="uploads-imagens">
                         ...
                         <label class="col-12">Conteúdo</label>
                         <textarea class="form-control" name="conteudo-destaque-5" rows='7'><?php echo $produto['conteudo_5']; ?></textarea>

                         <row class="col-12">
                             
                            <label class="col-12" style="margin-top: 31px;">Tópicos</label>

                            <textarea class="form-control" id="topicos-5" name="topico-5"> <?php echo $produto['topico_5']; ?> </textarea>
                    ...
                    <div id="6" style="display:none;" class="box-destaque">
                         <h1>6 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" value="<?php echo $produto['titulo_6']; ?>" type="text" name="titulo-destaque-6">
                         ...
                         <label class="col-12">Conteúdo</label>
                         <textarea class="form-control" name="conteudo-destaque-6" rows='7'> <?php echo $produto['conteudo_6']; ?> </textarea>

                         <row class="col-12">
                             
                            <label class="col-12" style="margin-top: 31px;">Tópicos</label>

                            <textarea class="form-control" id="topicos-6" name="topico-6"> <?php echo $produto['topico_6']; ?> </textarea>
                    ...
                    <div  id="7" style="display:none;" class="box-destaque">
                         <h1>7 º Destaque</h1>
                         <label>Titulo</label>
                         <input class="form-control" type="text" value="<?php echo $produto['titulo_7']; ?>" name="titulo-destaque-7">
                         ...
                         <textarea class="form-control" name="conteudo-destaque-7" rows='7'><?php echo $produto['conteudo_7']; ?></textarea>

                         <row class="col-12">
                             
                            <label class="col-12" style="margin-top: 31px;">Tópicos</label>

                            <textarea class="form-control" id="topicos-7" name="topico-7"> <?php echo $produto['topico_7']; ?> </textarea>
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                <label for="descricao" style="">Descrição do Produto</label>
            ...
            <div class="tabela tabela--galeria">
                ...
                <?php
                    if(count($produto['galeria']) > 0) {
                        foreach($produto['galeria'] as $galeria) {
                ?>
                    <div class="linha">
                        <div class="coluna">
                            <div class="banner_galeria__thumb" style="background-image: url('<?php echo site_url($galeria['url']); ?>');display: block;"></div>
                        </div>
                        <div class="coluna">
                            <a class="excluir-banner_galeria" href="<?php echo site_url('produtos/galeria/excluir/'.$galeria['codigo']); ?>">
                                <img src="<?php echo site_url('assets/images/ico-deletar.png'); ?>">
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-5">
            <div class="uploads-imagens">
                <div class="upload-imagem upload-imagem__virtual selected">
                    <div class="upload-imagem__thumb" style="background-image: url(<?php echo site_url($produto['banner_vitrine']); ?>);"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="descricao_img" name="descricao_img" value="<?php echo $produto['banner_alt']; ?>">
                    </div>
        ...
        <div class="col-12">
            <div class="form-group">
                <button class="btn btn--centro" type="submit">Finalizar</button>
            </div>
        </div>
    </div>
